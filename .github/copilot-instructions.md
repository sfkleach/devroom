...
Devroom is a command-line tool for Linux that spins up containers that act
as isolated virtual rooms for developing safely with AI agents such as Claude CLI.

Its official repository is https://github.com/sfkleach/devroom. The project is
open-source under the Affero General Public License v3.0 (AGPL-3.0) and is maintained by [Stephen Leach](https://github.com/sfkleach).
